...
More specific, sophisticated and efficient sampling strategies need to be developed. We here propose the usage of [block sampling]() instead of random sampling, which accounts for 
challenges 1. and 2. and enable efficient and meaningful ML applications on ARDCs.
